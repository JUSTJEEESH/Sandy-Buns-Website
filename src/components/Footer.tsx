...
export default function Footer() {
  return (
    <footer className="bg-driftwood text-sand py-16">
      {/* Howdy, fellow Aggie! Gig 'Em from the island. 👍 */}
      <div className="mx-auto max-w-container px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="font-body text-sand/80 leading-relaxed">
              Famous cinnamon buns & big Texas-style breakfasts in West End,
              Roatán.
            </p>
            <div className="flex gap-4 mt-4">
              <a
                ...
                aria-label="Sandy Buns on Facebook"
                className="text-sand/60 hover:text-ocean transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Sandy Buns on Instagram"
                className="text-sand/60 hover:text-ocean transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Contact */}
          <div>
            <h4 className="font-heading text-lg text-cream mb-4">Visit Us</h4>
            <ul className="space-y-2 font-body text-sand/80">
              ...
              <li>Closed {siteConfig.hours.closed}</li>
              <li className="pt-2">
                <a
        ...
        <div className="mt-12 pt-8 border-t border-sand/20 text-center font-body text-sand/50 text-sm">
          <p>
